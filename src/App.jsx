        ...
        <div className="div2">
          <main>
            ...
            >
              ...
              <p id="pMeio">
                Conheça nossos serviços e escolha o plano ideal para o seu pet.
              </p>
              <div id="content">
                <Promo
                  planType="Free"
                  benefits={["Tratamento Básico"]}
                  price={0}
                />
                <Promo
                  planType="Básico"
                  hasCustomHeader
                  benefits={["Tratamento Básico", "Banho e tosa"]}
                  price={50}
                />{" "}
                {/* hasCutomHeader é igual hasCustomHeader = true*/}
                <Promo
